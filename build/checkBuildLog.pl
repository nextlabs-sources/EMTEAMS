...
#	print "Line: $_\n";
	...
	# Include Cygwin cp error from Makefile.xlib
	if (/cp: cannot stat/)
	{
		# Add to collection
		push @msgList, $_;
	...
	# Include C# compiler warnings
	if (/warning MSB3245: Could not resolve this reference/)
	{
		# Add to collection
		push @msgList, $_;
...
#		print "Have error: $_";
		...
		# Exclude code warnings
		if (/warning C6283: 'errorAsString'|m_ShowErrorPage/)
		{
			next loop;
		}
